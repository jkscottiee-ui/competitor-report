...
- 검색 결과로 명확히 확인된 내용만 작성하고, 애매하거나 추측성 정보는 쓰지 마
- 확실한 정보가 없으면 반드시 "이번 주 특이 동향 없음" 한 줄만 작성 (억지로 만들어내지 마)
- 있다면 최대 3줄, 각 줄은 1문장 이내로 짧게
"""
    try:
...
def send_to_slack(text: str):
    ...
    print(f"Slack 전송 완료 ({total}개 메시지)")
